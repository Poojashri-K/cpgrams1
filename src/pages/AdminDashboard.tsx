...
import { fetchAdminData, updateGrievanceStatus } from "../lib/services"
import type { Grievance, GrievanceStatus } from "../lib/services"
...
export default function AdminDashboard() {
  ...
  useEffect(() => {
    fetchAdminData().then((data) => setItems(data.grievances))
  }, [])
    ...
    <section className="mx-auto max-w-6xl px-4 py-10">
      ...
      <div className="mt-8 grid gap-4 sm:grid-cols-4">
        ...
        <Card className="p-5">
          ...
          <p className="mt-2 text-3xl font-bold text-navy">10</p>
        </Card>
      </div>

      <Card className="mt-8 overflow-hidden">
        <div className="border-b p-5">
          <h2 className="font-semibold">Grievance management</h2>
        </div>
            ...
            >
              <div>
                ...
                <p className="mt-1 text-sm text-muted-foreground">
                  {item.regNumber} · {item.department} · {item.filedOn}
                </p>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <Select
                  ...
                  onChange={async (e) => {
                    ...
                    await updateGrievanceStatus(item.id, status)
